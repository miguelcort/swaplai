        ...
        <Card className="p-6 relative">
            ...
            <div className="flex items-center justify-between mb-6 pl-8">
                <div className="flex items-center gap-3">
                    ...
                    <h3 className="text-lg font-semibold text-text-primary uppercase tracking-wider font-sans">My Savings Plan</h3>
                </div>
...
function GoalCard({ icon, iconBg, name, current, target, percentage }: Goal) {
    return (
        <div className="p-4 bg-transparent border border-border hover:border-primary transition-colors group">
            <div className="flex items-start justify-between mb-3">
                <div className="flex items-center gap-3">
                    ...
                    <div>
                        <p className="text-sm font-medium text-text-primary font-sans uppercase tracking-wide">{name}</p>
